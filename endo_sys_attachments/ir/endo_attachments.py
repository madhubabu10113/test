...
class endo_attachments(osv.osv):
    ...
    def _data_set(self, cr, uid, id, name, value, arg, context=None):
        ...
        if location:
            ...
            super(endo_attachments, self).write(cr, SUPERUSER_ID, [id], {'store_fname': fname, 'file_size': file_size}, context=context)
        else:
            super(endo_attachments, self).write(cr, SUPERUSER_ID, [id], {'db_datas': value, 'file_size': file_size}, context=context)
        return True

    #_inherit = 'ir.attachment'
    _name = 'endo.attachments'
    _columns = {
    ...
    _defaults = {
        'type': 'binary',
        'file_size': 0,
        'company_id': lambda s,cr,uid,c: s.pool.get('res.company')._company_default_get(cr, uid, 'endo.attachments', context=c),
    }

    def _auto_init(self, cr, context=None):
        super(endo_attachments, self)._auto_init(cr, context)
    ...
    def check(self, cr, uid, ids, mode, context=None, values=None):
        """Restricts the access to an endo.attachments, according to referred model
    ...
    def read(self, cr, uid, ids, fields_to_read=None, context=None, load='_classic_read'):
        ...
        return super(endo_attachments, self).read(cr, uid, ids, fields_to_read, context, load)
    ...
    def write(self, cr, uid, ids, vals, context=None):
        ...
        if 'file_size' in vals:
            del vals['file_size']
        return super(endo_attachments, self).write(cr, uid, ids, vals, context)

    def copy(self, cr, uid, id, default=None, context=None):
        self.check(cr, uid, [id], 'write', context=context)
        return super(endo_attachments, self).copy(cr, uid, id, default, context)
    ...
    def unlink(self, cr, uid, ids, context=None):
        ...
        if location:
            for attach in self.browse(cr, uid, ids, context=context):
                if attach.store_fname:
                    self._file_delete(cr, uid, location, attach.store_fname)
        return super(endo_attachments, self).unlink(cr, uid, ids, context)

    def create(self, cr, uid, values, context=None):
        self.check(cr, uid, [], mode='write', context=context, values=values)
        if 'file_size' in values:
            del values['file_size']
        return super(endo_attachments, self).create(cr, uid, values, context)
